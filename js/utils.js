...
Global.initUtils = () => {
  Global.utils = {
    ...
    isHasScrollProgressBar: Global.theme_config.global.scroll_progress.bar === true,
    isHasScrollPercent: Global.theme_config.global.scroll_progress.percentage === true,
    ...
    contentAreaWidthAdjust() {
      ...
      const defaultMaxWidth = Global.theme_config.global.content_max_width || '1000px';
      const expandMaxWidth = '90%';
      let navbarMaxWidth = defaultMaxWidth;

      let isExpand = false;

      if (Global.theme_config.home_banner.enable === true && window.location.pathname === '/') {
    ...
    inithomeBannerHeight() {
      this.homeBanner_dom && (this.homeBanner_dom.style.height = this.innerHeight + 'px');
    },
